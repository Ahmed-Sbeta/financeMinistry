                                                ...
                                                <tbody>
                                                  ...
                                                  <tr>
                                                    <td>
                                                      ...
                                                      <th scope="row">{{$i}}</th>
                                                      <td> المصروفات الفعلية <span style="color: green;">{{number_format($ministry->payeds()->where('door_id', 1)->whereDate('date', now()->format('Y').'-'.$i.'-1')->sum('total'))}}</span> - المبلغ المفوض به <span style="color: green;">{{number_format($ministry->payeds()->where('door_id', 1)->whereDate('date', now()->format('Y').'-'.$i.'-1')->sum('given'))}}</span> </td>
                                                      <td> المصروفات الفعلية <span style="color: green;">{{number_format($ministry->payeds()->where('door_id', 2)->whereDate('date', now()->format('Y').'-'.$i.'-1')->sum('total'))}}</span> - المبلغ المفوض به <span style="color: green;">{{number_format($ministry->payeds()->where('door_id', 2)->whereDate('date', now()->format('Y').'-'.$i.'-1')->sum('given'))}}</span> </td>
                                                      <td> المصروفات الفعلية <span style="color: green;">{{number_format($ministry->payeds()->where('door_id', 3)->whereDate('date', now()->format('Y').'-'.$i.'-1')->sum('total'))}}</span> - المبلغ المفوض به <span style="color: green;">{{number_format($ministry->payeds()->where('door_id', 3)->whereDate('date', now()->format('Y').'-'.$i.'-1')->sum('given'))}}</span> </td>
                                                      <td> المصروفات الفعلية <span style="color: green;">{{number_format($ministry->payeds()->where('door_id', 4)->whereDate('date', now()->format('Y').'-'.$i.'-1')->sum('total'))}}</span> - المبلغ المفوض به <span style="color: green;">{{number_format($ministry->payeds()->where('door_id', 4)->whereDate('date', now()->format('Y').'-'.$i.'-1')->sum('given'))}}</span> </td>
                                                      <td> المصروفات الفعلية <span style="color: green;">{{number_format($ministry->payeds()->where('door_id', 5)->whereDate('date', now()->format('Y').'-'.$i.'-1')->sum('total'))}}</span> - المبلغ المفوض به <span style="color: green;">{{number_format($ministry->payeds()->where('door_id', 5)->whereDate('date', now()->format('Y').'-'.$i.'-1')->sum('given'))}}</span> </td>
                                                  </tr>
                                                  @endfor
