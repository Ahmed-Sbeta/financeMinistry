                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-6">
                                                    <div>
                                                        ...
                                                        <input id="worktitle" name="total" style="direction: rtl;"  value="{{$ministry->total}}" type="number" min="0" step="0.01" class="form-control" placeholder="الرجاء ادخال القيمة الشهرية..." oninvalid="this.setCustomValidity('الرجاء ادخال القيمة الشهرية')" oninput="this.setCustomValidity('')">
                                                    </div>
                                                </div>
