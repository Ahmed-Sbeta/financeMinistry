...
<html lang="en" dir="rtl">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>الــبــاب الـثـالـث</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">الــبــاب الــثــالــث</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="text-sm-end">
                                                  <a href="/items/3/edit">
                                                    <button type="button" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2"><i class="mdi mdi-plus me-1"></i> إضــافــة بــنـد جـديـد</button>
                                                    </a>                                                </div>
                                            </div><!-- end col-->
                                        </div>
                                                ...
                                                <tbody>
                                                  @foreach($items as $item)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="javascript: void(0);" class="text-body fw-bold">الـمـرتـبـات الأسـاسـيـة</a> </td>
                                                        <td></td>
                                                        <td>
