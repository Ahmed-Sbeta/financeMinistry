                                            ...
                                            <table class="table align-middle table-nowrap table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="font-size-14 mb-1"><a href="javascript: void(0);" class="text-dark">احمد محمد علي</a></h5>
                                                            <p class="text-muted mb-0">54781334</p>
                                                        </td>
                                                        <td>ahmedsbeita99@gmail.com</td>
                                                        <td> 33 44 555 092
                                                            <!-- <div>
                                                        ...
                                                        <td>
                                                            <div class="avatar-xs">
                                                              <a href="javascript: void(0);" class="d-inline-block">
                                                                  <img src="{{asset('assets/images/users/'.$user->image)}}" alt="" class="rounded-circle avatar-xs">
                                                                </a>
                                                            </div>
                                                        </td>
                                                        <td>
