...
<html lang="en" dir="rtl">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>إضافة جهة تابعة <span>{{$ministrie->name}}</span></title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">إضــائــة جهة تابعة <a href="{{route('ministries.index',[$ministrie->id])}}"><span>{{$ministrie->name}}</span></a></h4>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('ministries.store',[$ministrie->id])}}" method="post" enctype="multipart/form-data">
                                          @csrf
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mt-3">
                                                        <label for="formFile" class="form-label">صــورة الجهة المعنية (إختياري)</label>
