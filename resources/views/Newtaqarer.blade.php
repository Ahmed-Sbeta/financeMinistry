                             ...
                             @csrf
                               <div class="row">
                                   <div class="col-4 pb-2" lang="ar">
                                       ...
                                       <select name="ministry" id="Main" onchange="Ddselect();" class="form-control js-example-basic-single" multiple="multiple" lang="ar" required oninvalid="this.setCustomValidity('الرجاء اختيار جهة معينة')" oninput="this.setCustomValidity('')">
