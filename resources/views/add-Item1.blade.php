                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">إضــائــة بــنــد جـديـد</h4>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('additem',[$idd])}}" method="post" enctype="multipart/form-data">
                                          @csrf
                                            <div class="row mb-4">
                                                <label for="worktitle" class="col-form-label col-lg-2" style="font-size:140%;">أســم الــبــنــد</label>
                                                <div class="col-lg-10">
                                                    <input id="worktitle" name="worktitle" type="text" class="form-control" placeholder="...">
                                                </div>
                                            </div>
