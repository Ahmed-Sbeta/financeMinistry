                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="text-sm-end">
                                                  <a href="/items/1/edit">
                                                    <a href="{{route('items.create',[1])}}" type="button" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2"><i class="mdi mdi-plus me-1"></i> إضــافــة بــنـد جـديـد</a>
                                                    </a>
                                                </div>
                                            </div><!-- end col-->
