                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="fullname" name="name" type="text" class="form-control" placeholder="الإسم">
                                                    </div>
                                                    <div class="mb-3">
                                                ...
                                                <div class="col-sm-6">
                                                  <div class="mb-3">
                                                      ...
                                                      <input id="email" name="work_id" type="text" class="form-control" >
                                                  </div>
                                                    <div class="mb-3">
                                                        <label for="email">البــريــد الإلـكـترونـي</label>
                                                        <input id="email" name="email" type="text" class="form-control" placeholder="name@gmail.com">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="email">إعــادة كــلـمـة الــمرور</label>
                                                        <input id="email" name="confirmPassword" type="password" class="form-control" >
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                        ...
                                                        <select class="form-control select" name="role">
                                                            <option>اخــتــيـار</option>
                                                            <option value="مـــوظــف">مــوظـــف</option>
