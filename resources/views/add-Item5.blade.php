...
<html lang="en" dir="rtl">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>إضــافــة بند (الباب الخامس)</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">إضــائــة بــنــد جديد <a href="{{route('items.show',[5])}}">(الباب الخامس)</a></h4>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('items.store',[5])}}" method="post" enctype="multipart/form-data">
                                            @csrf                                            <div class="row mb-4">
                                                <label for="worktitle" class="col-form-label col-lg-2" style="font-size:140%;">أســم الــبــنــد</label>
                                                <div class="col-lg-10">
                                                    <input id="worktitle" name="worktitle" type="text" class="form-control" placeholder="الرجاء ادخال بند الباب الخامس..." required oninvalid="this.setCustomValidity('الرجاء ادخال البند')" oninput="this.setCustomValidity('')">
                                                </div>
                                            </div>
